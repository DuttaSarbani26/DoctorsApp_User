...
export const DoctorListFunction = async (
  ...
  try {
    ...
    const response = await axios.post(`${endPoints.doctor.doctorList}?${params.toString()}`);
...
export const GetDoctorSlotsFunction = async ({ doctorId, date }: { doctorId: string; date: string }) => {
  try {
